...
const Points = () => {
    ...
    const [initialPosition, setInitialPosition] = useState<[number, number]>([0, 0]); //array numérico só dos ids
    ...
    useEffect(() => { // essa chamada é executada toda vez que o usuário selecionar ou desmarcar um item 
      api.get('points', {
